        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: (isPlaces ? AppColors.secondary : AppColors.primary).withOpacity(0.1),
                shape: BoxShape.circle,
              ),
              child: Icon(
                isPlaces ? LucideIcons.heart : LucideIcons.navigation,
                color: isPlaces ? AppColors.secondary : AppColors.primary,
                size: 48,
              ),
            ),
          ...
          children: [
            ...
            Container(
              ...
              child: Icon(
                ...
                color: item.type == 'place' ? AppColors.secondary : AppColors.primary,
                size: 24,
              ),
            ),
