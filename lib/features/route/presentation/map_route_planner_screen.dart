  ...
  Widget _buildModeTab(int index, String title, IconData icon) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? AppColors.ciniMavisi : AppColors.surfaceLight,
          ...
          if (routeState.selectedRoute != null)
            ListTile(
              ...
              leading: Container(
                ...
                child: const Icon(LucideIcons.navigation, color: AppColors.ciniMavisi),
              ),
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(icon, color: AppColors.osmanliAltini, size: 24),
            ),
